...
module.exports = function (grunt) {
  grunt.initConfig({
    ...
    sass: {
      min: {
        files: {
          'dist/musikkitest.css': 'src/stylesheets/musikkitest.scss'
        },
        options: {
          sourcemap: 'none',
          style: 'expanded'
      ...
      unmin: {
        files: {
          'dist/musikkitest.min.css': 'src/stylesheets/musikkitest.scss'
        },
        options: {
          sourcemap: 'none',
          style: 'compressed'
    ...
    webpack: {
      ...
      //docs: require('./webpack.example.config')
    },
